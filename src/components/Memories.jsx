...
export default function Memories({ next, back }) {
  ...
  const data = {
    dream: [
      { src: "/memories/dreams/1.jpeg", caption: "Proposing Her" },
      { src: "/memories/dreams/2.jpeg", caption: "Kissing Her Hand" },
      { src: "/memories/dreams/3.jpeg", caption: "Giving Love Letter" },
      { src: "/memories/dreams/4.jpeg", caption: "Caring" },
      { src: "/memories/dreams/5.jpeg", caption: "My Love" },
      { src: "/memories/dreams/6.jpeg", caption: "Holding Her hand" },
      { src: "/memories/dreams/7.jpeg", caption: "Hugging Her" },
    ],
  };
